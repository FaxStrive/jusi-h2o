  ...
  return (
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"Service","name":"Water Testing","provider":{"@type":"LocalBusiness","name":"Jusi H2O","telephone":"+1-813-303-0515","url":"https://jusih2o.com"},"areaServed":[{"@type":"City","name":"Hillsborough County, FL"},{"@type":"City","name":"Pinellas County, FL"},{"@type":"City","name":"Sarasota County, FL"},{"@type":"City","name":"Tampa Bay, FL"},{"@type":"City","name":"Florida"}],"url":"https://jusih2o.com/water-testing","description":"Jusi H2O provides professional water testing services in your area. Free consultations available."}` }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How Much Does Water Testing Cost?","acceptedAnswer":{"@type":"Answer","text":"Water Testing costs vary based on your home's specific needs, existing infrastructure, and system specifications. Jusi H2O provides free in-home assessments with detailed written quotes — so you know exactly what you&apos;ll pay before committing to anything."}},{"@type":"Question","name":"How Long Does Water Testing Take?","acceptedAnswer":{"@type":"Answer","text":"Most residential water testing projects are completed in a single day. More complex installations may take 2 days. During your free consultation with Jusi H2O, we&apos;ll give you a specific timeline for your your area project."}},{"@type":"Question","name":"Do I Need a Permit for Water Testing?","acceptedAnswer":{"@type":"Answer","text":"Permit requirements depend on the specific work being done and local municipal regulations. Jusi H2O handles all required local permits as part of our service — we&apos;re familiar with local requirements and manage the paperwork on your behalf."}},{"@type":"Question","name":"What Warranty Does Jusi H2O Provide for Water Testing?","acceptedAnswer":{"@type":"Answer","text":"Jusi H2O provides manufacturer warranties on all equipment and a labor guarantee on all installations. Specific warranty terms are provided in writing before work begins. Most equipment carries 5–10 year manufacturer warranties."}},{"@type":"Question","name":"Does Jusi H2O Provide Water Testing in your area?","acceptedAnswer":{"@type":"Answer","text":"Yes, Jusi H2O serves your area and surrounding communities. Call (813) 303-0515 to confirm service availability in your specific neighborhood."}}]}` }}
      />
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl font-bold mb-6">Water Testing</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            Professional water testing services from Jusi H2O — serving your area and surrounding areas.
      ...
      <section className="py-16 px-4" aria-labelledby="benefits-heading">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-600 text-center max-w-2xl mx-auto mb-12">
            Serving your area homeowners with professional water testing since day one. Here&apos;s what sets us apart.
          </p>
      ...
      <section className="py-16 px-4 bg-gray-50" aria-labelledby="process-heading">
        <div className="max-w-4xl mx-auto">
          <h2 id="process-heading" className="text-3xl font-bold text-center mb-12">How Jusi H2O Delivers Water Testing in your area</h2>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="border-b border-gray-100 pb-6">
              ...
              <p className="text-gray-700">Water Testing costs vary based on your home&apos;s specific needs, existing infrastructure, and system specifications. Jusi H2O provides free in-home assessments with detailed written quotes — so you know exactly what you&apos;ll pay before committing to anything.</p>
            </div>
            <div className="border-b border-gray-100 pb-6">
              <h3 className="font-semibold text-lg mb-2">How Long Does Water Testing Take?</h3>
              <p className="text-gray-700">Most residential water testing projects are completed in a single day. More complex installations may take 2 days. During your free consultation with Jusi H2O, we&apos;ll give you a specific timeline for your your area project.</p>
            </div>
            <div className="border-b border-gray-100 pb-6">
            ...
            <div className="border-b border-gray-100 pb-6">
              <h3 className="font-semibold text-lg mb-2">What Warranty Does Jusi H2O Provide for Water Testing?</h3>
            ...
            <div className="border-b border-gray-100 pb-6">
              <h3 className="font-semibold text-lg mb-2">Does Jusi H2O Provide Water Testing in your area?</h3>
