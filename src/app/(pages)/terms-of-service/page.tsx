...
export const metadata: Metadata = {
  ...
  description: "Jusi H2O terms of service for water treatment customers. Review our terms including SMS/text messaging program details, opt-out instructions, and usage policies.",
    ...
    <>
      ...
      <section className="relative py-section overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 lg:px-8 prose prose-lg prose-headings:font-heading prose-headings:text-text prose-p:text-text-secondary prose-li:text-text-secondary prose-a:text-primary hover:prose-a:text-primary-dark">
          ...
          <p>
            You can cancel the SMS service at any time. Just text <strong>STOP</strong> to <a href="tel:+18133030515">(813) 303-0515</a> or reply <strong>STOP</strong> to any message you receive from us.
          </p>
          <p>
